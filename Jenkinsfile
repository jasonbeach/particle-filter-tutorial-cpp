...
def setupconan = {
  sh "conan remote add ssci https://frog1.ssci.com/artifactory/api/conan/raptor-packages false --insert"
...
pipeline {
  ...
  environment {
    ...
    pull_image_name = "frog1.ssci.com:443/raptor-docker/x86_64/1804/cuda10.2/trt/opencv453/ros2galactic/raptor/dev:latest"
