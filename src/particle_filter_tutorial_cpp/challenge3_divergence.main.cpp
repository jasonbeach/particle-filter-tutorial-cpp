...
/**
 * @brief This file demonstrates particle filter that is caused by setting a too low number of
 * particles. Note that (due to the stochastic nature of the filter it could happen that the filter
 * works fine during this short simulation. However, that will be the exception rather than the
 * rule.
 */
int main(int argc, char* argv[]) {
  ...
  fmt::print("Starting demonstration of particle filter divergence.\n");
